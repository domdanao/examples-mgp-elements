...
| `redirect.notify` | `string` | No | Webhook URL for async payment status notifications |
...
|-------|------|-------------|
| `owner.name` | `string` | No | Owner's full name |
| `owner.address_country` | `string` | No | Owner's country (ISO 3166-1 alpha-2) — cannot be empty if included |
| `owner.billing.name` | `string` | **Yes** | Billing contact full name (required if `billing` object present) |
| `owner.billing.phone_number` | `string` | No | Billing contact phone number (e.g. `"639175511222"`) |
| `owner.billing.email` | `string` | No | Billing contact email address |
| `owner.billing.line1` | `string` | No | Billing address line 1 |
| `owner.billing.line2` | `string` | No | Billing address line 2 |
| `owner.billing.city` | `string` | No | Billing city |
| `owner.billing.state` | `string` | No | Billing state or province |
| `owner.billing.country` | `string` | No | Billing country (ISO 3166-1 alpha-2) |
| `owner.billing.zip_code` | `string` | No | Billing postal code |
| `owner.shipping.name` | `string` | **Yes** | Shipping contact full name (required if `shipping` object present) |
| `owner.shipping.phone_number` | `string` | No | Shipping contact phone number |
| `owner.shipping.email` | `string` | No | Shipping contact email address |
| `owner.shipping.line1` | `string` | No | Shipping address line 1 |
| `owner.shipping.line2` | `string` | No | Shipping address line 2 |
| `owner.shipping.city` | `string` | No | Shipping city |
| `owner.shipping.state` | `string` | No | Shipping state or province |
| `owner.shipping.country` | `string` | No | Shipping country (ISO 3166-1 alpha-2) |
| `owner.shipping.zip_code` | `string` | No | Shipping postal code |
